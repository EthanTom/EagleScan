...
'''EagleScan, An Intelligent PE File Heuristics Scanner

   Written By : @Ice3man

   Requires :- Yara Library For python
            :- peFile Library
...
__author__ = "@Ice3man"
__version__ = "1.0"
__contact__ = "Iceman12@protonmail.com"

yarasig = "Yara-Rules.yara" #change this for custom rules
...
anti_dbg_imp = ['NtQueryInformationProcess', 'NtSetInformationThread', 'IsDebuggerPresent', 'CheckRemoteDebugger']
...
def main():
    print "   ____   _      ___   _     _____      ___   ___    _    ___    //    "
    print " //__   //_\\\\  //__   ||   //__   __  //__  //     //_\\\\  ||\\\\  // "
    print " \\\\___ //   \\\\ \\\\__/| ||___\\\\____    ___//  \\\\___ //   \\\\ || \\\\//\n"

    print "\n[*] EagleScan : A PE File Heuristics Scanner"
    print "[*] Written By : @Ice3man"
    print "[*] Email : EthanTom543@gmail.com"
